...
<div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    @endif
                                    <div class="card-body">
                                       <form method="post" action="{{ URL::to('store-student-login')}}">
                    {{ csrf_field() }}
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Student ID</label>
                                                <input class="form-control py-4" name="student_reg_id" type="text" placeholder="Enter ID" />
                                            </div>
                                            <div class="form-group">
